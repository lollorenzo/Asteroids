...
{
	const sf::Sprite& sprite_a = sprite;
	const sf::Sprite& sprite_b = other.sprite;

	const sf::IntRect bounding_box_a(sprite_a.getGlobalBounds());
	const sf::IntRect bounding_box_b(sprite_b.getGlobalBounds());
